...
export const componentsList = [
  ...
  { path: '/pages-tmui/nav/dropdown', title: '下拉选项 dropdown' },
  { path: '/pages-tmui/nav/navbar', title: '导航栏 navbar' },
  { path: '/pages-tmui/nav/pagination', title: '分页 pagination' },
  { path: '/pages-tmui/nav/segtab', title: '分段器 segtab' },
  { path: '/pages-tmui/nav/steps', title: '步进器 steps' },

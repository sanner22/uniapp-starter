<template>
  <tm-app>
    <tm-sheet>
      ...
      <view>
        <tm-image preview :width="300" :height="200" src="https://picsum.photos/200/300"></tm-image>
      </view>
    </tm-sheet>
    <tm-sheet>
      <tm-text :font-size="24" _class="font-weight-b" label="关闭按钮"></tm-text>
      <tm-divider></tm-divider>
      <view>
        <tm-image delete preview :width="300" :height="200" src="https://picsum.photos/200/300?id=666"> </tm-image>
      </view>
    </tm-sheet>
    <tm-sheet>
      <tm-text :font-size="24" _class="font-weight-b" label="展示额外的内容"></tm-text>
      <tm-divider></tm-divider>
    ...
    <tm-sheet>
      <tm-text :font-size="24" _class="font-weight-b" label="图片组，组成简单的相册集"></tm-text>
      <tm-divider></tm-divider>
      <tm-image-group>
        <tm-image
          :padding="[2, 2]"
